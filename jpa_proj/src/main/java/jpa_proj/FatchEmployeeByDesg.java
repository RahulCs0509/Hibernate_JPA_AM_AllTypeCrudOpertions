...
public class FatchEmployeeByDesg {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter your desg to print the detials");
		String edesg = sc.next();
		String qry = "select e from Employee e where e.edesg=?1";
		...
		if (emps.size() > 0) {
			...
			System.out.println("No Employee Found With the desg: " + edesg);
		}
	}
